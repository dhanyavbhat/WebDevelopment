            ...
            <div class="container">
               ...
               <div class="collapse navbar-collapse" id="Navbar">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="./category.php">Artist</a></li>
                        <li class="nav-item"><a class="nav-link" href="./about.php">About</a></li>
                        <li class="nav-item"><a class="nav-link" href="index.php?logout='1'">Logout</a>
                      </li><li class="nav-item"><p style="color:white;"><?php echo $username;?></p></li>
                    </ul>
                </div>            
            </div>
        </nav>
