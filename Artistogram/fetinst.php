...
$categ='Artist';
$sql = "SELECT fname,lname,phno,email,cate,address,discript FROM register inner join artist on register.username=artist.username where cate='Instrument'";
            ...
            <div class="container">
               ...
               <div class="collapse navbar-collapse" id="Navbar">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="./category.php">Artist</a></li>
